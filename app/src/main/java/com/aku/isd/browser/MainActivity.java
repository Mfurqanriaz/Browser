    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       superWebView.setDownloadListener(new DownloadListener() {
           ...
           public void onDownloadStart(String url, String userAgent, String contentDisposition,
               ...
               DownloadManager myManger = (DownloadManager) getSystemService (DOWNLOAD_SERVICE);
               myManger.enqueue(myRequest);

               Toast.makeText(MainActivity.this,  "your is file is downloading", Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.menu_share:
                    ...
                    startActivity(Intent.createChooser(shareIntent,  "Share with friend url"));
